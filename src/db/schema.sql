...
CREATE TABLE compliance_rules (
  ...
  category TEXT NOT NULL CHECK(category IN ('FORMATION','TAXATION','EMPLOYMENT','LICENSING','REPORTING','PRIVACY','INSURANCE','ENVIRONMENTAL','ACCESSIBILITY','CORPORATE_GOVERNANCE','INDUSTRY_SPECIFIC')),
